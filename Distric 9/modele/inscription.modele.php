...
function insert($pseudo, $firstName, $lastName, $datenaiss, $email, $telephone, $age, $mdp) {
	global $bdd;
	$insertion = $bdd->prepare("INSERT INTO users (pseudo, firstName, lastName, datenaiss, email, telephone, age, mdp, lvl) 
        VALUES (:pseudo, :firstName, :lastName, :datenaiss, :email, :telephone, :age, :mdp, 1)");
